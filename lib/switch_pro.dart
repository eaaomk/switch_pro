...
class _MaterialSwitchState extends State<_MaterialSwitch> with TickerProviderStateMixin, ToggleableStateMixin {
  ...
  void initState() {
    ...
    super.initState();
    _painter = _SwitchPainter(kTrackRadius:widget.kTrackRadius, kTrackHeight: widget.kTrackHeight, kThumbRadius: widget.kThumbRadius,);
  }
...
class _SwitchPainter extends ToggleablePainter {
  ...
  _SwitchPainter({required this.kTrackRadius,required this.kTrackHeight ,required this.kThumbRadius});
